...
public interface ISessionManager
{
    ...
    /// </summary>
    void Set<T>(ISession session, string key, T value); // NOSONAR S1700,CA1716 - session API convention; VB.NET callers can use fully-qualified name
    ...
    /// </summary>
    T? Get<T>(ISession session, string key); // NOSONAR S1700,CA1716 - session API convention
